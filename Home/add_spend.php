...
<div id="content">
  ...
  <div class="container mt-4">
    ...
    <div class="card shadow">
      <div class="card-body pb-0">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="spend.php">Spend</a></li>
    ...
    <div class="card shadow my-4 bg-light">
      <div class="card-body">
        <h4>Add Spending History</h4>
        <div class="card">
          <div class="card-body p-3">
            <form action="config/spend/add.php" method="POST">
              <div class="form-floating mb-3">
                <input type="text" name="name" class="form-control" id="floatingInput">
                <label for="floatingInput">Detail Spending</label>
              </div>
              <div class="form-floating mb-3">
