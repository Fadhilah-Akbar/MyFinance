...
<div id="content">
  ...
  <div class="container mt-4">
    ...
    <div class="card shadow my-4">
      <div class="card-body">
        <h4>Your Income History</h4>
        <div class="card">
          <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-2">
              <div>
                  <a class="btn btn-primary" href="add_income.php" type="button">
            ...
            <table id="incomeTable" class="table table-striped table-bordered my-3" style="width:100%">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Date</th>
...
<script>
  $(document).ready(function() {
    table = $('#incomeTable').DataTable({
      "ajax": {
        "url": "config/income/fetch.php", // Replace with the path to your PHP script
        "dataSrc": ""
      },
      "columns": [
        { 
        ...
        { 
          ...
          "render": function (data, type, row) {
            ...
            return `<a href="edit_income.php?id=${row.id}" class="btn btn-sm btn-warning">Edit</a>
                    <a href="config/income/delete.php?id=${row.id}" class="btn btn-sm btn-danger">Delete</a>`;
          }
        }
      ],
